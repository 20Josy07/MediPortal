...
const prompt = ai.definePrompt({
  ...
  prompt: `Transcribe el siguiente audio. Asegúrate de corregir cualquier error gramatical u ortográfico para que el texto final sea limpio, preciso y profesional.
